...
public class ProductController {
	...
	public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
		...
		if (product != null && product.getPrix() == 0) {
			throw new ProduitGratuitException(
					"Le prix de vente proposé est égal à 0 . Ce n'est pas encore les soldes.");
		}
	...
	public Map<Product, Integer> calculerMargeProduit() {
		...
		Map<Product, Integer> result = produits.stream()
				.collect(Collectors.toMap(e -> e, e -> e.getPrix() - e.getPrixAchat()));
